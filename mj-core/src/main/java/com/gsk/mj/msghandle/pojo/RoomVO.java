...
public class RoomVO {
	...
	public RoomInfo toRoomInfo(){
        ...
        room.setIshong(this.getHong()?"1":"0");
        room.setGametype(this.getRoomType()+"");
        room.setMa(this.getMa());
        room.setRoomid(this.getRoomId());
        room.setSevendouble(this.getSevenDouble()?"1":"0");;
        room.setXiayu(this.getXiaYu());
        room.setZimo(this.getZiMo()==0?"0":"1");
        room.setName(this.getName());
        room.setAddwordcard(this.isAddWordCard()?"1":"0");
        room.setCreateTime(new Date());
        room.setCardNumb(this.getRoundNumber()/8);
        return room;
    }
